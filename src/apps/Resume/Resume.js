    ...
    <div className="main-container-word">
      ...
      <div className="toolbar-top">
        <div className="toolbar-top-block-left">
          <div
            style={{ backgroundImage: `url(${i_new})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_open})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_save})` }}
            className="toolbar-item"
          ></div>
          <div className="vl-toolbar"></div>
          <div className="vl-toolbar-white"></div>
          <div
            style={{ backgroundImage: `url(${i_print})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_preview})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_spellcheck})` }}
            className="toolbar-item"
          ></div>
          <div className="vl-toolbar"></div>
          <div className="vl-toolbar-white"></div>
          <div
            style={{ backgroundImage: `url(${i_cut})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_copy})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_paste})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_style})` }}
            className="toolbar-item"
          ></div>
          <div className="vl-toolbar"></div>
          <div className="vl-toolbar-white"></div>
          <div
            style={{ backgroundImage: `url(${i_undo})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_redo})` }}
            className="toolbar-item"
          ></div>
        </div>
      ...
      <div className="toolbar-bottom">
        <div className="toolbar-bottom-block-left">
          <div
            style={{ backgroundImage: `url(${i_bold})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_italic})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_underline})` }}
            className="toolbar-item"
          ></div>
          ...
          ></div>
          <div
            style={{ backgroundImage: `url(${i_center})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_right})` }}
            className="toolbar-item"
          ></div>
          <div className="vl-toolbar"></div>
          <div className="vl-toolbar-white"></div>
          <div
            style={{ backgroundImage: `url(${i_number})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_bullet})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_indent})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_outdent})` }}
            className="toolbar-item"
          ></div>
          <div className="vl-toolbar"></div>
          <div className="vl-toolbar-white"></div>
          <div
            style={{ backgroundImage: `url(${i_highlight})` }}
            className="toolbar-item"
          ></div>
          <div
            style={{ backgroundImage: `url(${i_fontcolor})` }}
            className="toolbar-item"
          ></div>
        </div>
      </div>
      <div className="working-area-word">
        <div className="text-area-word">
          <iframe
            src="https://drive.google.com/file/d/1diXHY4xYJAJiTiDkJT8emrydPtnPDS_M/preview"
            className="test"
          ></iframe>
        </div>
